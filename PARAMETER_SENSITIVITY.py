...
param_ranges = {
    'infection_prob': np.linspace(0.02, 0.2, 3),
    'recovery_prob': np.linspace(0.02, 0.2, 3),
    'waning_prob': np.linspace(0.0005, 0.01, 3),
    'mixing_rate': np.linspace(0.0, 0.8, 3),
}
    ...
    for param_name, values in param_ranges.items():
        ...
        for val in values:
            ...
            if param_name == 'mixing_rate':
                ...
                # Vary other parameters as before
                ca_hist, ca_initial_infected_frac = run_ca_simulation(
                    infection_prob=p['infection_prob'],
                    recovery_prob=p['recovery_prob'],
                    waning_prob=p['waning_prob'],
