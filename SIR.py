...
class Grid:
    def __init__(self, width, height, infection_prob=0.25, recovery_time=30):
        self.width = width
        self.height = height
...
class Simulation:
    def __init__(self, width=100, height=100, cell_size=6, infection_prob=0.25, recovery_time=30):
        pygame.init()
        self.width = width
        self.height = height
        self.cell_size = cell_size
        self.screen = pygame.display.set_mode((width * cell_size, height * cell_size))
        pygame.display.set_caption("SIR Disease Spread Cellular Automata")
        self.grid = Grid(width, height, infection_prob, recovery_time)
...
if __name__ == "__main__":
    sim = Simulation(width=100, height=100, cell_size=6, infection_prob=0.15, recovery_time=7)
    sim.run()