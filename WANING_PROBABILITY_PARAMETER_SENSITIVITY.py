...
waning_prob_values = np.linspace(0.0, 0.250, 21)  # More frequent values
...
def waning_prob_sensitivity_experiment():
    ...
    plot_comparison_with_error("waning_prob", waning_prob_values, ca_results, ode_results, params['t_max'], params['ode_dt'], plots_per_figure=5)
